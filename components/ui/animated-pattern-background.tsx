export function AnimatedPatternBackground() {
  return (
    <div className="animated-pattern-container">
      <svg
        ...
        <defs>
          ...
          >
            <g transform="scale(0.6)">
              <defs>
                <g id="pattern-shape">
                  <polyline
                    ...
                    strokeDasharray="140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476 140.817 49.476"
                  >
                    <animate
              ...
              <use xlinkHref="#pattern-shape" x="0" y="0"></use>
              <use xlinkHref="#pattern-shape" x="-256" y="0"></use>
              <use xlinkHref="#pattern-shape" x="256" y="0"></use>
              <use xlinkHref="#pattern-shape" x="0" y="-256"></use>
              <use xlinkHref="#pattern-shape" x="0" y="256"></use>
            </g>
          </pattern>
        </defs>
